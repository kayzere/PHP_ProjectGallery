...
class Gallery_model extends Model {
  ...
  public function create_album($album_name) {
    try {
      ...
      // ajouter une base de donnée qui fait reference au user.
      // ajouter les données avec l'id du user. la foreigne key.
  ...
  public function check_if_photo_exists($photo_id) {
    try {
      $statement = $this->db->prepare("select * from photos where photo_id = :photo_id");
